...
import SwapFactory from '@BakerySwap2021/bakery-swap-core/build/BakerySwapFactory.json'
import ISwapPair from '@BakerySwap2021/bakery-swap-core/build/IBakerySwapPair.json'
