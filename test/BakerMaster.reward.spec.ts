...
const getTotalRewardInfoInSameCommonDifference = (
  ...
  if (_to.lte(startBlock) || maxRewardBlockNumber.lte(_from)) {
    return new BigNumber(0)
  }
  if (_from.lt(startBlock)) {
    _from = startBlock
  }
...
describe('BakeryMaster', () => {
  ...
  it('getTotalRewardInfo', () => {
    let totalReward = getTotalRewardInfo(startBlock.sub(1000), bonusEndBlock)
  ...
  it('getTotalRewardInfoInSameCommonDifference2', () => {
    // (startBlock, startBlock+29999]
    let totalReward = getTotalRewardInfoInSameCommonDifference(
      startBlock.sub(10000),
      startBlock.add(0),
      bakeStartBlock,
      bonusBeforeBulkBlockSize,
      bonusBeforeCommonDifference
    )
    console.log('getTotalRewardInfoInSameCommonDifference2 2: ' + totalReward)
  })
})
